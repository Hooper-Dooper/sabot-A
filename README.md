...
<form id="reserveForm">
   <input type="hidden" name="shopType" value="A"> 
...
<script>
const GAS_URL="https://script.google.com/macros/s/AKfycbwqnXCYtTJX2ZxzZbRcYdxR9BzKM_XXb5lGo3muj_MY0ZlN_wg8hYty2A-UDQvlYtgc/exec";
